      ...
      <div className="container mx-auto px-4 flex flex-col lg:flex-row gap-10 lg:gap-20">
        ...
        <div className="flex-1 flex flex-col lg:flex-row gap-10 lg:gap-20">
          ...
          <div className="lg:w-1/3">
            <h3 className="text-2xl font-bold text-yellow-600 mb-4 dark:text-yellow-400">{t("site_name")}</h3>
        ...
        {/* Right Column: Map */}
        <div className="lg:w-1/3">
          <h3 className="text-xl font-bold text-yellow-600 mb-4 dark:text-yellow-400">{t("footer_location_title")}</h3>
