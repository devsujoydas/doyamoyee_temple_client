...
import { FaFacebook, FaInstagram, FaYoutube, FaGlobe, FaPlus, FaTrash, FaEdit } from "react-icons/fa";
...
const ProfilePage = () => {
    ...
    const user = {
        ...
        profileImage: "https://metropolitanhost.com/themes/themeforest/wp/maharatri/wp-content/uploads/2021/09/1-4-100x100.jpg",
        coverImage: "https://metropolitanhost.com/themes/themeforest/wp/maharatri/wp-content/uploads/2021/09/2.jpg",
        contactDetails: {
            facebook: "#",
            instagram: "#",
            youtube: "#",
        ...
        totalPost: 12,
        createdAt: "2024-01-26T21:06:04.432+00:00",
    };
        ...
        <div className="pb-20">
            ...
            <div className="custom-container">
                ...
                <div className="flex flex-col items-center -mt-20">
                    ...
                    {/* Role Badge */}
                    <span className={`mt-2 px-3 py-1 rounded-full text-sm ${user.role === "admin" ? "bg-red-100 text-red-600" : "bg-blue-100 text-blue-600"}`}>
                        {user.role}
                    </span>
                    ...
                    <div className="flex gap-5 mt-4 text-xl text-gray-600">
                        <a href={user.contactDetails.facebook}><FaFacebook /></a>
                        <a href={user.contactDetails.instagram}><FaInstagram /></a>
                        <a href={user.contactDetails.youtube}><FaYoutube /></a>
                        <a href={user.contactDetails.website}><FaGlobe /></a>
                    </div>
