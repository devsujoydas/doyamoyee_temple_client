  ...
  return (
    <div className='flex justify-center items-center h-screen'>
      <div className='text-center space-y-2'>
        ...
        <button onClick={()=>navigate(-1)} className='bg-amber-400 px-4 py-2 rounded-md hover:bg-amber-200 cursor-pointer active:scale-95 transition-all'>Reload Page</button>
      </div>
    </div>
  )
}
