    ...
    <div className="w-full lg:w-1/3 space-y-8 rounded-xl">
      ...
      {blog?.author && (
        <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 text-center">
          ...
          <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4">{blog.author.bio}</p>
          <div className="flex justify-center gap-3 sm:gap-4 text-gray-600 text-sm sm:text-base">
            <a href="#"><FaFacebookF className="hover:text-[#7E4555] transition" /></a>
            <a href="#"><FaTwitter className="hover:text-[#7E4555] transition" /></a>
            <a href="#"><FaInstagram className="hover:text-[#7E4555] transition" /></a>
          </div>
        </div>
      )}
