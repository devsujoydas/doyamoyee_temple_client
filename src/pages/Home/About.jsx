      ...
      <div className="custom-container">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            ...
            {/* Establishment Card */}
            <motion.div
              className="bg-white/80 backdrop-blur-md shadow-xl rounded-2xl p-6 border border-amber-200 space-y-3 hover:shadow-2xl transition-transform transform hover:-translate-y-1"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.8, delay: 0.3 }}
            >
              <h4 className="text-xl sm:text-2xl font-semibold text-amber-700 mb-3">
